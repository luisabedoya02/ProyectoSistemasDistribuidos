...
public class ProductoDao {
     ...
     */
    public Producto getObject(Connection conn, int id) throws NotFoundException, SQLException {
    ...
    public List searchMatching(Connection conn, Producto valueObject) throws SQLException {
          ...
          if (valueObject.getPrecio() != null) {
              if (first) { first = false; }
              sql.append("AND precio LIKE '").append(valueObject.getPrecio()).append("%' ");
          }
          ...
          if (valueObject.getId_menu() != 0) {
              if (first) { first = false; }
              sql.append("AND id_menu = ").append(valueObject.getId_menu()).append(" ");
          }
