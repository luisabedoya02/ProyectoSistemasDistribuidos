...
public class Mesas extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		// jLabel7.setIcon(new
		// javax.swing.ImageIcon(getClass().getResource("/img1/chat.png"))); // NOI18N
		...
		jComboBoxRestaurante.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Restaurante 1" }));

		jComboBoxEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Libre", "Ocupado" }));
								...
								.addGroup(layout.createSequentialGroup()
										...
										.addGap(44, 44, 44).addGroup(
												layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
														.addComponent(jComboBoxEstado).addComponent(jTextFieldCodigo)))
								.addGroup(layout.createSequentialGroup().addComponent(jLabel3).addGroup(layout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(layout.createSequentialGroup().addGap(86, 86, 86).addGroup(layout
						...
						.addGroup(
								layout.createSequentialGroup().addContainerGap().addComponent(jLabel7)
										...
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(jTextFieldCodigo, javax.swing.GroupLayout.PREFERRED_SIZE,
	...
	private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt)
		...
		if (cm.searchMesaId(id)) {
			...
			mesas[1] = m.getCodigo_mesa();

			mesas[2] = m.getEstado();
			mesas[3] = m.getNombre_restaurante();
			modeloMesas.addRow(mesas);
			jTableMesas.setModel(modeloMesas);
		}
	...
	private void jButtonActualizarActionPerformed(java.awt.event.ActionEvent evt)
		...
		m.setAll(id, codigoMesa, estado, restaurante);

		System.out.println(m.toString());

		if (cmesa.updateMesa(m)) {
